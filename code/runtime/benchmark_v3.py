...
R=pathlib.Path('/autocar/.cache_pt_pytorch2/nuplan_recovery_20260910');out=R/'fm2_top250_benchmark_v3';out.mkdir(exist_ok=True)
...
gpu=DTPPTTCPlanner(checkpoint=str(checkpoint),device='cuda',use_ef=True,fm_steps=2,chunk_size=500,enable_guard=True)
