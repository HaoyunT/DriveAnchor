...
export NUPLAN_EXP_ROOT=/tmp/dp_eval/exp_hardv
...
/home/user/anaconda3/envs/pytorch_env/bin/python3.10 $NUPLAN_DEVKIT_ROOT/nuplan/planning/script/run_simulation.py \
  ...
  scenario_builder=nuplan_challenge scenario_filter=hardv_s$SHARD \
  experiment_uid=driveanchor_fag/test14hardv/$CHALLENGE/s$SHARD \
