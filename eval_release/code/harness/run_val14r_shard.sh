...
export NUPLAN_EXP_ROOT=/tmp/dp_eval/exp_val14r
...
/home/user/anaconda3/envs/pytorch_env/bin/python3.10 $NUPLAN_DEVKIT_ROOT/nuplan/planning/script/run_simulation.py \
  ...
  scenario_builder=nuplan scenario_filter=val14r_s$SHARD \
  experiment_uid=driveanchor_fag/val14/$CHALLENGE/s$SHARD \
